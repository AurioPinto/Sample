<template>
  <div>
    ...
    <div>
      ...
      <ul>
        <li class="list" v-for="character in characters" :key="character">
          {{ character }}
        </li>
      </ul>
      <ul>
        <li v-for="(apdevices, index) in apdevices" :key="apdevices">
          {{ index }} . {{ apdevices.name }} - {{ apdevices.age }}
        </li>
      </ul>
      <!-- </div> -->
