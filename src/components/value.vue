﻿<template>
  <div class="detail">
    ...
    <transition name="life-way" @after-enter="pageEnter(1)">
      ...
      <div class="life-way" v-show="screenIndex === 1">Shaping a World with New Technologies</div>
    </transition>
    <!--Third screen -->
    <template>
    ...
    <transition name="box-fourth" @after-enter="pageEnter(3)">
      <div class="box-fourth" v-show="screenIndex === 3" :class="{'boxEn':language !== 'CHS'}">
    ...
    <transition name="box-sixth" @after-enter="pageEnter(5)">
      <div class="box-sixth" v-show="screenIndex === 5" :class="{'boxEn':language !== 'CHS'}">
    ...
    <span class="arrow-down" :class="{'arrow-white': screenIndex === 2}" v-if="screenIndex !== 5"></span>
    <span
      class="arrow-up"
